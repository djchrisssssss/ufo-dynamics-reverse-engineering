# Section 2: Observable Characteristics — References

## Primary Sources

1. [src-013] Touboul, P. et al. "MICROSCOPE Mission: Final Results of the Test of the Equivalence Principle." *PRL* 129, 121102 (2022).
   - DOI: https://doi.org/10.1103/PhysRevLett.129.121102
2. [src-010] Dyson, F.W., Eddington, A.S. & Davidson, C. "A determination of the deflection of light by the Sun's gravitational field." *Phil. Trans. Roy. Soc. A* 220, 291–333 (1920).
...
| s02-005 | MICROSCOPE EP precision | ~10⁻¹⁵ | src-013 |
| s02-006 | Speed of sound (sea level) | 343 m/s | Standard atmosphere |
| s02-007 | Shuttle reentry temperature | ~1,650°C | NASA thermal data |
| s02-008 | F-117 radar cross-section | 0.001–0.01 m² | DoD program records |
| s02-009 | Solar light deflection | 1.75 arcseconds | src-010 |
| s02-010 | Water/air density ratio | ~830× | Standard physical constants |
