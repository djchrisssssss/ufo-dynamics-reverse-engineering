# Section 9: Mathematical and Relativistic Foundations for Anomalous Flight — References

## Primary Sources

1. [src-048] Misner, C.W., Thorne, K.S. & Wheeler, J.A. *Gravitation.* W.H. Freeman (1973).
2. [src-049] Wald, R.M. *General Relativity.* University of Chicago Press (1984).
3. [src-013] Touboul, P. et al. "MICROSCOPE mission: Final results of the test of the equivalence principle." *PRL* 129, 121102 (2022).
...
7. [src-006] Bobrick, A. & Martire, G. "Introducing physical warp drives." *CQG* 38, 105009 (2021).
   - DOI: https://doi.org/10.1088/1361-6382/abdf6e
8. [src-007] Fell, S.D.B. & Heisenberg, L. "Positive energy warp drives from hidden geometric structures." *CQG* 38, 155020 (2021).
...
| Note ID | Claim focus | Related sources |
|---------|-------------|-----------------|
| ref-122 | Invariant kinematics; proper acceleration; geodesic motion | src-013, src-048, src-049 |
| ref-123 | ADM split and Alcubierre metric ansatz | src-001, src-048, src-049 |
| ref-124 | Negative energy in classical warp geometries | src-002 |
| ref-125 | Null energy condition violation in generic warp drives | src-005 |
| ref-126 | Conservative positive-energy branch versus exotic branch | src-006, src-007 |
| ref-127 | Report-level synthesis and dimensionless model-building program | src-001, src-002, src-005, src-006, src-048, src-049 |
| ref-128 | Fowler phenomenology used as narrative input rather than measurement | Fowler 1995 (auxiliary source) |
...
This section is intentionally formula-centric and currently introduces no standalone quantitative data points. The placeholder file `data/statistics/s09-theoretical-foundations-stats.json` is reserved for future empirical constraints.
