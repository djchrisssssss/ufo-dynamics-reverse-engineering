...
collaboration between the human author and Claude~(Anthropic), specifically the
Claude Opus~4 and Claude Sonnet~4 models. AI contributions included literature
synthesis and cross-referencing of 54 bibliography sources, equation typesetting
in both Markdown and \LaTeX, structural organization of the eight-section
...
CSVs, source registry), and translation of the full text into Traditional Chinese.
...
\textbf{Data verification.}\ 43 of the 44 quantitative data points cited in this
assessment are independently cross-checked against their cited sources; one
contested estimate is retained as low-confidence analysis. Source provenance,
...
Document Identifier: IRD-UAP-2026-001. Version~1.1, March~2026.
DOI: \href{https://doi.org/10.5281/zenodo.19138271}{10.5281/zenodo.19138271}.
\end{acknowledgments}
